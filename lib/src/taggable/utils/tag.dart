...
/// A utility class that represents a tag in the form of a tagged object and a
/// tag style.
class Tag<T> {
  /// Creates a new Tag instance.
  /// 
  /// The [taggable] parameter is required and represents the element that can 
  /// be tagged.
  /// The optional [style] parameter defines the visual appearance of the tag,
  /// defaulting to a default [TagStyle].
  ...
  ///
  /// Important: the backend string created by this method is not the true
  /// backend representation of the tag. Both frontend and backend strings are
  /// modified to have the same length, so that the frontend text field's 
  /// cursor behaviour matches the [TypeSetEditingController]'s internal cursor
  /// behaviour. This is done by inserting zero-width spaces in the 
  /// representation that is shorter.
